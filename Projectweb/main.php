...
<head>
    ...
    <title>Document</title>
     <link rel="stylesheet" href="ِbootstrap.min.css">
...
<body>
   <section class="head">
        ...
        <pre class="cairo">
            حل شفرة حضارتنا!
            ستظهر لك كلمة مكتوبة بالحروف الهيروغليفية،ومهمتك هي فك كل 
            حرف باستخدام لوحة الحروف الهيروغليفية والعربية
            الكلمة التي ستكتشفها ستكون اسم ملك او مكان او رمز من مصر
            القديمة،ولو جاوبت صح سوف تظهر لك معلومة دقيقه وممتعة عنه. 
            اختبر ذكاءك، وافتح باب جديد من اسرار المصريين القدماء
        </pre>


        <button class="cairo" onclick="window.location.href='AboutGame.php'">اكتشف الاسرار الأن</button>
   </section>
